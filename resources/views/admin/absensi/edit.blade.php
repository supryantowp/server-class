...
<div class="row">
      <div class="col-12">
            <div class="card">
                  ...
                  <div class="card-body">
                        <form action="{{route('daftar_absensi.update', ['daftar_absensi' => $absensi->id])}}" class="mt-3" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select name="siswa" class="form-control @error('siswa') is-invalid @enderror select2">
                                                ...
                                                <option value="{{$siswa->id}}" {{$absensi->siswa_id == $siswa->id ? 'selected' : null}}>{{$siswa->nama}}</option>
                                                @endforeach
                                          </select>
                                          @error('siswa')
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select name="keterangan" class="form-control @error('keterangan') is-invalid @enderror select2">
                                                <option value="">pilih</option>
                                                <option value="hadir" {{$absensi->keterangan == 'hadir' ? 'selected' : null}}>Hadir</option>
                                                <option value="izin" {{$absensi->keterangan == 'izin' ? 'selected' : null}}>Izin</option>
                                                <option value="sakit" {{$absensi->keterangan == 'sakit' ? 'selected' : null}}>Sakit</option>
                                                <option value="alfa" {{$absensi->keterangan == 'alfa' ? 'selected' : null}}>Alfa</option>
                                          </select>
                                          @error('keterangan')
                                          <div class="invalid-feedback">
                                                {{$message}}
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <textarea name="alasan" class="form-control @error('alasan') is-invalid @enderror">{{$absensi->alasan}}</textarea>
                                          @error('keterangan')
                                          <div class="invalid-feedback">
                                                {{$message}}
                                          </div>
