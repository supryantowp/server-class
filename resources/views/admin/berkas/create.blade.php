...
<div class="row">
      <div class="col-12">
            <div class="card">
                  ...
                  <div class="card-body">
                        <form action="{{route('berkas.store')}}" method="post" class="mt-3" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <textarea name="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror">{{old('deskripsi')}}</textarea>
                                          @error('deskripsi')
                                          <div class="invalid-feedback">
                                                {{$message}}
                                          </div>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select name="type" class="form-control select2 @error('type') is-invalid @enderror">
                                                ...
                                                <option value="pdf" {{old('type') == 'pdf' ? 'selected' : null}}>pdf</option>
                                                <option value="word" {{old('type') == 'word' ? 'selected' : null}}>word</option>
                                                <option value="image" {{old('type') == 'image' ? 'selected' : null}}>image</option>
                                          </select>
                                          @error('type')
                                          <div class="invalid-feedback">
                                                {{$message}}
