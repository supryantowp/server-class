...
<div class="row">
      <div class="col-12">
            <div class="card">
                  ...
                  <div class="card-body">
                        <form action="{{route('jadwal_piket.update', ['jadwal_piket' => $piket->id])}}" method="post" class="mt-3">
                              @csrf
                              @method('PUT')
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select class="form-control select2 @error('hari') is-invalid @enderror" name="hari">
                                                ...
                                                <option value="{{$hari->id}}" {{$piket->hari_id == $hari->id ? 'selected' : null}}>{{$hari->hari}}</option>
                                                @endforeach
                                          </select>
                                          @error('hari')
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select class="form-control select2 @error('siswa') is-invalid @enderror" name="siswa">
                                                ...
                                                <option value="{{$siswa->id}}" {{$piket->siswa_id == $siswa->id ? 'selected' : null}}>{{$siswa->nama}}</option>
                                                @endforeach
                                          </select>
                                          @error('siswa')
                                          <div class="invalid-feedback">
